 ...
 */
public class DeliveryChuteSimulator extends
	 ...
	 */
	public DeliveryChuteSimulator(int capacity) {
		if (capacity <= 0)
			throw new SimulationException("Capacity must be a positive value: "
					+ capacity);
	...
	private void notifyItemDelivered() {
		Class<?>[] parameterTypes = new Class<?>[] { DeliveryChuteSimulator.class };
		Object[] args = new Object[] { this };
		notifyListeners(DeliveryChuteListener.class, "itemDelivered",
				parameterTypes, args);
	}
	...
	private void notifyDoorOpened() {
		Class<?>[] parameterTypes = new Class<?>[] { DeliveryChuteSimulator.class };
		Object[] args = new Object[] { this };
		notifyListeners(DeliveryChuteListener.class, "doorOpened",
				parameterTypes, args);
	}
	...
	private void notifyDoorClosed() {
		Class<?>[] parameterTypes = new Class<?>[] { DeliveryChuteSimulator.class };
		Object[] args = new Object[] { this };
		notifyListeners(DeliveryChuteListener.class, "doorClosed",
				parameterTypes, args);
	}
	...
	private void notifyChuteFull() {
		Class<?>[] parameterTypes = new Class<?>[] { DeliveryChuteSimulator.class };
		Object[] args = new Object[] { this };
		notifyListeners(DeliveryChuteListener.class, "chuteFull",
				parameterTypes, args);
	}
}
