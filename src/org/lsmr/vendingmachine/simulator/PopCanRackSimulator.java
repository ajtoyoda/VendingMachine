...
public class PopCanRackSimulator extends AbstractHardware<PopCanRackListener> {
	...
	public PopCanRackSimulator(int capacity) {
		if (capacity <= 0)
			throw new SimulationException("Capacity cannot be non-positive: "
					+ capacity);
	...
	private void notifyPopAdded(PopCan pop) {
		Class<?>[] parameterTypes = new Class<?>[] { PopCanRackSimulator.class,
				PopCan.class };
		Object[] args = new Object[] { this, pop };
		notifyListeners(PopCanRackListener.class, "popAdded", parameterTypes,
				args);
	}
	...
	private void notifyPopFull() {
		...
		notifyListeners(PopCanRackListener.class, "popFull", parameterTypes,
				args);
	}

	public void notifyPopEmpty() {
		Class<?>[] parameterTypes = new Class<?>[] { PopCanRackSimulator.class };
		Object[] args = new Object[] { this };
		notifyListeners(PopCanRackListener.class, "popEmpty", parameterTypes,
				args);
	}
	...
	private void notifyPopRemoved(PopCan pop) {
		Class<?>[] parameterTypes = new Class<?>[] { PopCanRackSimulator.class,
				PopCan.class };
		Object[] args = new Object[] { this, pop };
		notifyListeners(PopCanRackListener.class, "popRemoved", parameterTypes,
				args);
	}
}
